...
,SUM(Mobile_Calls_To_NonAdvertisers) AS Mobile_Calls_To_NonAdvertisers
,SUM(Messages_To_NonAdvertisers) AS Messages_To_NonAdvertisers
,SUM(Mobile_Calls_To_NonAdvertisers) AS Mobile_Calls_To_Advertisers
,SUM(Messages_To_NonAdvertisers) AS Messages_To_Advertisers
FROM (
SELECT Date
...
/*THEN 'LS-Package-Details' (old logic; no longer in use) */
