...
AND chan_def.lpv_page_type = 'Homepage'
	THEN 'SEO - Brand'
when chan_def.lpv_source IN ('utm_sorce=elocal', 'utm_source=pbx', 'utm_source=marchex') then 'Marchex/eLocal/pbx Calls'
