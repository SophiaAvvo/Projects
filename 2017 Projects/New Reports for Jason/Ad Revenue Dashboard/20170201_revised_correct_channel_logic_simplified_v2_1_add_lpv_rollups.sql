...
-- , a.PA
,case  
WHEN LEFT(LOWER(lpv_campaign)) = 'c:b'
	THEN 'SEM Brand'
WHEN LEFT(LOWER(lpv_campaign)) = 'c:nb'
	THEN 'SEM Brand'
WHEN LEFT(LOWER(lpv_campaign)) = 'c:de'
	THEN 'Display & Emerging'
WHEN LEFT(LOWER(lpv_campaign)) = 'c:eng'
	THEN 'Digital Engagement'
WHEN LEFT(LOWER(lpv_campaign)) = 'c:ce'
	THEN 'Consumer Email'
WHEN LEFT(LOWER(lpv_campaign)) = 'c:ae'
	THEN 'Attorney Email'
WHEN LEFT(LOWER(lpv_campaign)) = 'c:p'
	THEN 'Partners'	  
when v3.lpv_content = 'utm_content=sgt' or v3.lpv_medium = 'utm_medium=sem%2F%3Futm_source%3Dgoogle%2F%3Futm_content%3Dsgt' or v3.lpv_campaign = 'utm_campaign=sgt'
                    then 'GDN Network'
when v3.lpv_source = '' 
