...
join chan_def 
	...
	AND chan_def.lpv_referring_domain = (CASE when v3.lpv_source = '' and v3.lpv_medium = '' and v3.lpv_campaign = '' and v3.lpv_content = '' AND v3.lpv_referring_domain IN ('', 'N/A') THEN 1 ELSE 0 END)
