...
,eu.resolved_user_id AS user_id
...
,CASE
	WHEN r.LastReview >= als.first_purchase_date
		THEN 'Still Active'
	WHEN r.LastEmail >= als.first_purchase_date
		THEN 'Still Active'
	WHEN r.LastWebsiteClick >= als.first_purchase_date
		THEN 'Still Active'
	WHEN r.LastQuestion >= als.first_purchase_date
		THEN 'Still Active'
