SELECT pd.*
           ...
           ,(SUBSTR(upper(pd.emaildomain),length(pd.emaildomain)-3)) EmailDomainSubTest
           ,substr(pd.emaildomain, 1, length(pd.emaildomain) - instr(pd.emaildomain,'.')+1) EmailDomainSubTest
