...
Date AS Date
	...
	,Non_Phone_Total_Daily_Contacts AS Non_Phone_Total_Daily_Contacts
	,Email_and_Web_Contacts/Non_Phone_Total_Daily_Contacts Phone_Attribution_Weights
...
FROM (SELECT Date AS Date
    ,Sessions AS Sessions
	,Email_and_Web_Contacts AS Email_and_Web_Contacts
	,SUM(Email_and_Web_Contacts) OVER(PARTITION BY Date) Non_Phone_Total_Daily_Contacts
    ,ClicksToLawyerWebsite AS ClicksToLawyerWebsite
    ,NumberQuestionsAsked AS NumberQuestionsAsked
    ,NumberQuestionsAnswered AS NumberQuestionsAnswered
    ,EmailSentToLawyers AS EmailSentToLawyers
