...
12/28/2016: Split off older data (pre Oct 2016) for a static data source, and will attempt to UNION with 
*/

SELECT 
Date AS Date_Old
,Sessions AS Sessions_Old
,Non_Phone_Contacts_Daily_Channel AS Non_Phone_Contacts_Daily_Channel_Old
,Non_Phone_Contacts_Daily_Total AS Non_Phone_Contacts_Daily_Total_Old
,Non_Phone_Contacts_Quarterly_Channel AS Non_Phone_Contacts_Quarterly_Channel_Old
,Non_Phone_Contacts_Quarterly_Total AS Non_Phone_Contacts_Quarterly_Total_Old
,Non_Phone_Contacts_Weekly_Channel AS Non_Phone_Contacts_Weekly_Channel_Old
,Non_Phone_Contacts_Weekly_Total AS Non_Phone_Contacts_Weekly_Total_Old
,Non_Phone_Contacts_Daily_Channel/Non_Phone_Contacts_Daily_Total Phone_Attribution_Weights_Daily_Old
,Non_Phone_Contacts_Weekly_Channel/Non_Phone_Contacts_Weekly_Total Phone_Attribution_Weights_Weekly_Old
,Non_Phone_Contacts_Quarterly_Channel/Non_Phone_Contacts_Quarterly_Total Phone_Attribution_Weights_Quarterly_Old
,ClicksToLawyerWebsite AS ClicksToLawyerWebsite_Old
,NumberQuestionsAsked AS NumberQuestionsAsked_Old
,NumberQuestionsAnswered AS NumberQuestionsAnswered_Old
,EmailSentToLawyers AS EmailSentToLawyers_Old
,NumberOfReviews AS NumberOfReviews_Old
,NumberOfClaims AS NumberOfClaims_Old
,NumberOfEndorsements AS NumberOfEndorsements_Old
,NumberOfRegistrations AS NumberOfRegistrations_Old
,MobileClicksToCall AS MobileClicksToCall_Old
,TotalCouponsUsed AS TotalCouponsUsed_Old
,Channel AS Channel_Old
,TotalAdvisorPurchases AS TotalAdvisorPurchases_Old
,TotalDocReviewPurchases AS TotalDocReviewPurchases_Old
,TotalOfflinePackagePurchases AS TotalOfflinePackagePurchases_Old
,ChannelGroup AS ChannelGroup_Old
,ChannelSortOrder AS ChannelSortOrder_Old
, ChannelGroupSortOrder AS ChannelGroupSortOrder_Old
