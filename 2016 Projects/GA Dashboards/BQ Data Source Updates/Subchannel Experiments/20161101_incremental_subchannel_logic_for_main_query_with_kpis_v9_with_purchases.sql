...
,SUM(CASE
		WHEN hits.customMetrics.index = 17
			THEN 1
		ELSE 0
	END) NumberOfForms8 -- this matches the custom metric but we still don't have a match on the goal
,SUM(CASE
...
FROM TABLE_DATE_RANGE ([75615261.ga_sessions_], TIMESTAMP('2016-02-01'),TIMESTAMP('2016-10-31'))
