...
tabcmd get "/views/CombinedRegisteredUserDashboardCRUD/RUSummary.png" -f "C:\Users\srobinson\Documents\TabCMD\view26.png" --timeout 500

::tabcmd get "/views/DigitalMarketingChannelReportGA/KPIOverview?Channel%20Type=All" -f "C:\Users\srobinson\Documents\TabCMD\view27.png" --timeout 500
tabcmd logout

::@echo off
python c:\image_cropper_1.py %*
pause
