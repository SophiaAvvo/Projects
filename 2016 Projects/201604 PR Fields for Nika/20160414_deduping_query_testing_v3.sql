...
SELECT pfad.PROFESSIONAL_ID
		...
		,ps.JUDGE
				...
				,ps.OFFICIAL 
				,ps.UNVERIFIED
				,ps.SANCTIONED, pfad.NonNullPhone1Check, pfad.NonNullEmailCheck, pfad.NullPhone1Check, pfad.NullEmailCheck, pfad.DoubleNullCheck
        ,CASE
