...
,a.sum_profile_views
,a.sum_impressions
,cam.total_email_attributed_count
,cam.total_website_attributed_count
,cam.total_email_attributed_count/ad.sum_sl_sold_inventory AS emails_per_sold_block
,cam.total_website_attributed_count/ad.sum_sl_sold_inventory AS website_clicks_per_sold_block
,a.sum_profile_views/ad.sum_sl_sold_inventory AS profile_views_per_sold_block
,a.sum_impressions/ad.sum_sl_sold_inventory AS impressions_per_sold_block
