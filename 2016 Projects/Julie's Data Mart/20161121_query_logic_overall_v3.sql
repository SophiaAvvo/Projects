...
LEFT JOIN dm.ad_market_dimension amd -- to eliminate nulls
	ON amd.ad_market_id = md.ad_market_id
LEFT JOIN dm.ad_region_dimension ard -- to eliminate nulls
...
,ad.state
,ad.Specialty
,ad.County_Specialty AS County_PA
...
,COALESCE(pv.pageviews, 0) AS pageview_count
,ad.Unsold_Rank
,CASE
