...
UID_add AS (
  SELECT COALESCE(t2.persistent_session_id, t.persistent_session_id) persistent_session_id
,t.user_id
,CASE
...
FROM traffic t
	...
	LEFT JOIN (SELECT DISTINCT persistent_session_id
		FROM tmp_data_dm.sr_paid_channels
			) ch	
		ON ch.persistent_session_id 
