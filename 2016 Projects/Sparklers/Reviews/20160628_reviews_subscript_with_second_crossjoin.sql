SELECT professional_id
  ...
  ,SUM(recommended)/COUNT(recommended) Pct_Recommended -- cannot include second crossjoin with these calculations because it skews them
  ,AVG(overall_rating) AvgRating -- skewed by second crossjoin
FROM (      
      SELECT professional_id,
             Review_Id
             ,recommended
