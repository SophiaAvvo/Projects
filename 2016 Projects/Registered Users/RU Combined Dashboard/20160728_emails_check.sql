/* seems to run fine in Tableau; not sure what the problem was, but hopefully this resolves it.  :(
...
,up.WindowStart
,up.WindowEnd
,from_unixtime(ci.gmt_timestamp, 'yyyy-MM-dd HH:mm:ss') DateConvert
,ci.event_date
,min(CASE 
