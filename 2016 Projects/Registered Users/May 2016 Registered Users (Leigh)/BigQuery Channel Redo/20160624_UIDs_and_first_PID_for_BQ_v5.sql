...
,DATE_ADD(uad.user_account_register_datetime, -1) day_before_reg_sec
...
WHERE uad.user_account_register_datetime = '2015-02-01'-- BETWEEN '2015-02-01' AND '2015-06-01'
-- ORDER BY 1,2
              )
